...
v5: .space 256
v6: .space 256
m: .word 2 ; intero su 64 bit
a: .space 8 ; elemento double ( su 64 bit )
b: .double 1.5
...
ori R11,R0,1 ; indice del multiplo 
...
ld R12,m(R0) ; carico in memoria il valore di m

IF: 

bnez R11,ELSE

dsllv R13,R12,R10 ;shift logico di m di i posizioni
